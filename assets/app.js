document.addEventListener('DOMContentLoaded', () => {
    ...
    'thixx_standard': { 
        ...
        lockTheme: false, 
        icons: { 
            icon192: "/THiXX-PPS/assets/THiXX_Icon_Grau6C6B66_Transparent_192x192.png", 
            icon512: "/THiXX-PPS/assets/THiXX_Icon_Grau6C6B66_Transparent_512x512.png" 
        }, 
        brandColors: { 
            primary: "#d54b2a",
            secondary: "#6c6b66" 
    ...
    'peterpohl': { 
        ...
        lockTheme: false, 
        icons: { 
            icon192: "/THiXX-PPS/assets/PP-192x192.png", 
            icon512: "/THiXX-PPS/assets/PP-512x512.png" 
        }, 
        brandColors: { 
            primary: "#00457D", 
            secondary: "#FFEC00" 
        ...
        'othimm': { 
            appName: "O.Thimm NFC Tool", 
            short_name: "O.Thimm", 
            theme: "customer-brand", 
            lockTheme: false, 
            icons: { 
                icon192: "/THiXX-PPS/assets/icon-192.png", 
                icon512: "/THiXX-PPS/assets/icon-512.png" 
            }, 
            brandColors: { 
                primary: "#d54b2a", 
                secondary: "#6C6B66" 
